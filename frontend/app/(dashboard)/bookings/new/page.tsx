        ...
        {step === 1 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 rounded-2xl border border-blue-200 bg-blue-50 p-4">
              <label className="block text-sm font-semibold text-gray-800 mb-1">Место сбора / откуда забираем туриста</label>
              <input
                {...register('pickupLocation')}
                placeholder="Например: Шымкент, Mega Planet, главный вход, 05:30"
                className="w-full px-4 py-2.5 border border-blue-200 rounded-xl bg-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <p className="text-xs text-blue-700 mt-2">
                Это поле попадёт в список бронирований по туру и в Excel-экспорт тура.
              </p>
            </div>
            <div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-xl p-4 space-y-3">
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div className="col-span-2"><span className="text-gray-500">Место сбора:</span> <span className="font-medium">{formValues.pickupLocation || 'Не указано'}</span></div>
              </div>
            </div>
